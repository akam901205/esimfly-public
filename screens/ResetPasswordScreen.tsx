...
import {
 ...
 StatusBar, Dimensions, Animated, KeyboardAvoidingView, Platform, 
...
const ANIMATION_SIZE_MULTIPLIER = 0.4;
           ...
           >
             <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
               ...
               <View style={styles.inputContainer}>
                 <Icon name="key-outline" size={20} color={colors.stone[600]} style={styles.inputIcon} />
                 <TextInput
                   style={styles.input}
